    ...
    return Material(
      ...
      child: Container(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Header row — Expanded prevents overflow
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Expanded(
            ...
            const SizedBox(height: 20),
            // ── Stat row: use Expanded + IntrinsicHeight to prevent overflow ──
            Container(
            ...
            const SizedBox(height: 12),
            ..._fac.map((f) {
              final enabled = imm[f.$2] == true;
              return Padding(
                padding: const EdgeInsets.only(bottom: 10),
                child: Row(
                  children: [
                    Icon(f.$3, color: Colors.white.withOpacity(0.7), size: 17),
